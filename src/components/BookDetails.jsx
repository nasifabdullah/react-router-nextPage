      ...
      <div className='flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto'>
        ...
        <div className=' p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2'>
          ...
          {fold ? (
            ...
            <span className='cursor-pointer text-blue-600 font-semibold' onClick={() => setFold(!fold)}>Read More</span>
            </>
          ) :
          (
            <>
            <p className=' text-gray-500'>{desc}</p>
            <span className='cursor-pointer text-blue-600 font-semibold' onClick={() => setFold(!fold)}>Read Less</span>
            </>
          )
